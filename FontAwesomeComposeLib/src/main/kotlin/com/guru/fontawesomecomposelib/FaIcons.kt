 ...
 *
 * Most icons are solid(1400+) then branded(450+) then regular(160+) at last.
 *
...
object FaIcons {
    ...
    // Solid icon : SquareBinary
    val SquareBinary = SolidIcon(0xe69b)
    ...
    // Solid icon : TableCellsColumnLock
    val TableCellsColumnLock = SolidIcon(0xe678)
    ...
    // Brands icon : BraveReverse
    val BraveReverse = BrandIcon(0xe63d)
    ...
    // Solid icon : BangladeshiTakaSign
    val BangladeshiTakaSign = SolidIcon(0xe2e6)
    ...
    // Brands icon : SquareLetterboxd
    val SquareLetterboxd = BrandIcon(0xe62e)
    ...
    // Brands icon : SquareXTwitter
    val SquareXTwitter = BrandIcon(0xe61a)
    ...
    // Brands icon : 500px
    val FiveHundred500px = BrandIcon(0xf26e)
    ...
    // Solid icon : WebAwesome
    val WebAwesome = SolidIcon(0xe682)
    ...
    // Brands icon : SquareBluesky
    val SquareBluesky = BrandIcon(0xe6a3)
    ...
    // Brands icon : GoogleScholar
    val GoogleScholar = BrandIcon(0xe63b)
    ...
    // Solid icon : FileFragment
    val FileFragment = SolidIcon(0xe697)
    ...
    // Brands icon : Shoelace
    val Shoelace = BrandIcon(0xe60c)
    ...
    // Brands icon : SquareWebAwesomeStroke
    val SquareWebAwesomeStroke = BrandIcon(0xe684)
    ...
    // Brands icon : SquareThreads
    val SquareThreads = BrandIcon(0xe619)
    ...
    // Solid icon : FileHalfDashed
    val FileHalfDashed = SolidIcon(0xe698)
    ...
    // Brands icon : DartLang
    val DartLang = BrandIcon(0xe693)
    ...
    // Brands icon : SquareUpwork
    val SquareUpwork = BrandIcon(0xe67c)
    ...
    // Brands icon : Letterboxd
    val Letterboxd = BrandIcon(0xe62d)
    ...
    // Solid icon : HexagonNodesBolt
    val HexagonNodesBolt = SolidIcon(0xe69a)
    ...
    // Solid icon : TableCellsRowUnlock
    val TableCellsRowUnlock = SolidIcon(0xe691)
    ...
    // Brands icon : SignalMessenger
    val SignalMessenger = BrandIcon(0xe663)
    ...
    // Regular icon : FaceKissWinkHeart
    ...
    // Brands icon : Bluesky
    val Bluesky = BrandIcon(0xe671)

    // https://fontawesome.com/icons/chart-diagram?style=solid
    // Solid icon : ChartDiagram
    val ChartDiagram = SolidIcon(0xe695)
    ...
    // Solid icon : CommentNodes
    val CommentNodes = SolidIcon(0xe696)
    ...
    // Brands icon : XTwitter
    val XTwitter = BrandIcon(0xe61b)
    ...
    // Brands icon : 42Group
    val FortyTwo42Group = BrandIcon(0xe080)
    ...
    // Regular icon : FaceGrinBeamSweat
    ...
    // Brands icon : Opensuse
    val Opensuse = BrandIcon(0xe62b)
    ...
    // Regular icon : FaceGrinTongueWink
    ...
    // Solid icon : HexagonNodes
    val HexagonNodes = SolidIcon(0xe699)
    ...
    // Regular icon : FaceGrinSquintTears
    ...
    // Brands icon : SquareWebAwesome
    val SquareWebAwesome = BrandIcon(0xe683)
    ...
    // Regular icon : FaceGrinTongueSquint
    ...
    // Solid icon : TableCellsRowLock
    val TableCellsRowLock = SolidIcon(0xe67a)
    ...
    // Solid icon : ThumbtackSlash
    val ThumbtackSlash = SolidIcon(0xe68f)
